(function ($) {
  ...
  $( document ).ready(function() {
    ...
    //
    // Countdown
    var time = '2020/11/11 8:00'; //Change this date with your counting date. Its Format is "Y/M/D"
    ...
    //
    // Video Background
    $('.site-header').vide('assets/video/talk');
    ...
    //
    // Google Map
    var mapLocation = new google.maps.LatLng(36.879638, 10.335884); //change coordinates here
    var marker;
    var map;
